...
provider "azurerm" {
    ...
    client_secret   = SERVICE_PRINCIPLE_CLIENT_SECRET
}
...
resource "azurerm_linux_web_app" "main" {
    ...
    site_config {
        application_stack {
            ...
            docker_registry_username = DOCKER_SERVER_USR
            docker_registry_password = DOCKER_SERVER_PWD
        }
    }
    app_settings = {
        "FLASK_APP" = FLASK_APP
        "FLASK_DEBUG" = FLASK_DEBUG
        "MONGODBASE_CONN_STRING" = MONGODBASE_CONN_STRING
        "MONGODBASE" = MONGODBASE
